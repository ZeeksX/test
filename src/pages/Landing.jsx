...
import AcadAIInAction from "../components/landing/AcadAIInAction";
...
import OurReasonsSection from "../components/landing/OurReasonsSection";
...
import DemoGrade from "../components/landing/DemoGrade";
import Assessment from "../components/landing/Assessment";
// import HelpsGrade from "../components/landing/HelpsGrade";
import Testimonials from "../components/landing/Testimonials";
import ReadyToGrade from "../components/landing/ReadyToGrade";
...
const Landing = ({ sidebarOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      {/* <div
        className="bg-gradient-to-t from-[#C7CEEC] w-full p-4 mt-10"
        id="home"
      >
        <div className="flex flex-row justify-center items-center w-full mt-2">
          <button
            disabled
            className="h-10 flex md:w-52 w-40 items-center justify-center md:mt-12 border border-[#1836B2] text-[#1836B2] font-normal text-sm p-2 rounded-full bg-[#86c7ed4f]"
          >
            Reclaim your time
          </button>
        </div>
        <div className="flex flex-col justify-center items-center w-full mt-8">
          <h1 className="font-metropolis text-center font-bold text-5xl leading-[107%] tracking-[0%] max-w-[900px] md:text-6xl xl:text-[80px] md:leading-[65px] xl:leading-[85.86px] items-center">
            <div className="inline-block font-metropolis mr-4 leading-tight">
              Turn Hours of{" "}
            </div>
...
const BetaWaitlistDialog = () => {
  ...
  const submitEmail = async (e) => {
    ...
    try {
      ...
      if (status === 400) {
        showToast(
          "That email looks invalid to us, please check again.",
          "error"
        );
      } else {
  ...
  return (
    ...
    >
      <div className="w-full p-8 px-10 relative overflow-hidden">
        <img
          src={firstabsolute}
        ...
        <div className="flex flex-col relative z-10">
          <h3 className="font-metropolis font-bold text-[16.61px] md:text-[28px] leading-[100%] text-center">
            Get to know more about Acad AI!
          </h3>
          <form
