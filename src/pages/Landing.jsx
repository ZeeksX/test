    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center items-center w-full mt-8'>
                <h1 className='metropolis w-[85vw] md:w-3/5 xl:w-[70%] flex text-center font-medium text-5xl leading-[50px] md:text-6xl xl:text-[80px] md:leading-[65px] xl:leading-[85.86px] items-center'>Turn Hours of Grading into Minutes.</h1>
                <h3 className='inter max-md:w-[85vw] flex text-center font-normal text-2xl leading-[29.05px] items-center mt-6'>Streamline your workflow with automated exam creation, proctoring, and grading.</h3>
