    ...
    return (
        <div className="landing flex flex-col items-center justify-center w-full min-h-screen">
            ...
            <div className="sign-in flex flex-row lg:w-3/5 lg:h-[90vh]">
                ...
                <div className="login flex flex-col w-4/5 mx-auto max-w-96 lg:max-w-screen-lg md:w-full md:rounded-r-2xl bg-white text-black px-4 lg:px-3 border gap-4 2xl:gap-6 py-4">
