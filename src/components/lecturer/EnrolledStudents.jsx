  ...
  return (
    <div className="p-4 bg-[#F9F9F9] min-h-screen">
      <div className="flex flex-row max-md:flex-col justify-between items-start">
        ...
        <div className="flex flex-row gap-4 p-4 max-md:mr-2">
          <button
            onClick={() => dispatch(setShowShareStudentGroupLinkDialog(true))}
      ...
      <div className="flex flex-row justify-between items-center my-4">
        <h1 className="text-[32px] font-inter font-normal leading-8 p-4">
          {group.name}
        </h1>
        <div className="flex items-end justify-end gap-4 max-md:mr-2 p-4">
      ...
      {group.students?.length > 0 ? (
        ...
        <div className="">There are no students in this group</div>
      )}
    </div>
  );
};
