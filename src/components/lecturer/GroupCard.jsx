...
const GroupCard = ({ group }) => {
  ...
  return (
    <div className="flex flex-col font-inter rounded-[20px] w-full max-w-[422px] h-[378px] bg-white shadow-lg p-1">
      ...
      <div className="h-[100px] bg-[#F9F9F9] rounded-b-[20px] flex items-center justify-between p-1 px-4">
        ...
        <div className="flex">
          <span className="flex flex-row gap-2 cursor-pointer items-center text-[#155EEF]">
            Copy link
