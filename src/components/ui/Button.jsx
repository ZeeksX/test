...
export const CustomButton = ({
  ...
  const classes = `${baseStyles} ${variantStyles[variant] || variantStyles.primary} ${sizeStyles[size] || sizeStyles.base} ${className}`;
...
CustomButton.propTypes = {
  ...
  variant: PropTypes.oneOf(["primary", "ghost", "clear", "accent", "icon", "danger"]), // Added danger
...
export const variantStyles = {
  ...
  ghost: "bg-neutral-ghost text-text-ghost hover:bg-primary-main hover:text-white",
  clear: "bg-transparent text-text-main border border-neutral-border hover:border-primary-main hover:text-primary-main",
