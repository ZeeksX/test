...
export const CreateNewExam = () => {
  ...
  const handlePublish = async () => {
    ...
    const body = {
      ...
      created_with: examData.examCreationMethod,
      source_file: "",
  ...
  const handleSaveExam = async () => {
    ...
    dispatch(setShowSaveExamToDraftDialog({ willShow: true, exam: body }));
  };
                  ...
                  <div className="flex w-full items-center justify-between">
                    ...
                    {currentStep > 2 && (
                      <CustomButton
                        ...
                        // variant="primary"
                        className="h-max w-[150px] gap-2 border border-primary-main !bg-secondary-bg !text-black"
                      >
                        Save to Draft
                      </CustomButton>
                    )}
                    ...
                    <div className="flex w-full justify-end gap-6 mt-8">
                      ...
                      {currentStep === 5 ? (
                        <div className="flex gap-3 ml-auto">
                          {/* <CustomButton variant="ghost" className="w-1/3">
                            Draft
                          </CustomButton> */}
                          <CustomButton
                            // variant="ghost"
