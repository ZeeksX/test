    ...
    return (
        <>
            {showDropDown && (
                ...
                >
                    <button className="px-4 py-2 text-left hover:bg-gray-100 rounded" onClick={() => alert("Navigate to settings")}>
                        Account Settings
                    </button>
                    <button className="px-4 py-2 text-left hover:bg-gray-100 rounded" onClick={() => alert("Navigate to billing")}>
                        Manage Billings
                    </button>
